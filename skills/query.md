...
description: >
  ...
  filter evolution. Triggers on: wiki query, wiki q.
---
...
- `wiki query what is event sourcing?`
- `wiki q compare FastAPI vs Express`
- `wiki query how do I deploy Caddy?`
...
- **Is concise** — this is a wiki query, not an essay. A few paragraphs max.
...
| Pattern | Behavior |
|---------|----------|
| `wiki q what is X?` | Find entity or concept page, summarize with citations |
| `wiki q compare A vs B` | Find comparison page or synthesize from entity pages |
| `wiki q how do I X?` | Find recipe page or synthesize from relevant pages |
| `wiki q what do I know about X?` | List all pages related to X with brief summaries |
| `wiki q recent` | Show pages created/updated in the last 30 days |
